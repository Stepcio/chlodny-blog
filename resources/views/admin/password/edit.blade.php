...
@section('content')
    <div class="max-w-sm mx-auto px-4 py-10">
        <h1 class="text-2xl font-bold text-stone-800 mb-6">Zmiana hasła</h1>
        ...
        <form method="POST" action="{{ route('admin.password.update') }}" class="space-y-4">
            ...
            <div>
                <label for="current_password" class="block text-sm font-medium text-stone-600">Obecne hasło</label>
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-stone-600">Nowe hasło</label>
                <input type="password" name="password" id="password" required
                    class="mt-1 w-full rounded-lg border border-stone-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-400">
            </div>

            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-stone-600">Potwierdź nowe hasło</label>
